...
@section('section')
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-lg-12 pt-60">
                    <p>
                        ...
                        advancement are concerned. The history of video game is as interesting as a fairy tale.
                    </p>
                    <p>
                        ...
                        electronic devices with various display formats. The first ever video game was designed in 1947 by
    ...
    <section class="timeline pb-120">
        ...
        <ul>
            ...
            <li>
                <div class="content">
                    <img class="img-fluid mx-auto d-block mb-30" src="img/about/xc-logo.png.pagespeed.ic.nvWw01ZP-Y.png"
                        alt="">
                    <h4>
